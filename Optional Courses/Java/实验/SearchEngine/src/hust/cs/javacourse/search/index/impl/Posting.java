...
/**
 * <pre>
 * Posting是AbstractPosting对象的具体实现.
...
public class Posting extends AbstractPosting implements Comparable<AbstractPosting>, FileSerializable {
    ...
    public boolean equals(Object obj) {
        if(obj instanceof Posting){
            ...
            return posting.docId==this.docId
                    &&posting.freq==this.freq
                    &&posting.positions.equals(this.positions);
        }
        return false;
    }
    ...
    public void readObject(ObjectInputStream in) {
        try {
            setDocId((int) (in.readObject()));
            setFreq((int)(in.readObject()));
            setPositions((List<Integer>) (in.readObject()));
