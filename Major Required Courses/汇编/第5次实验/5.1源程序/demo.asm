...
AppName      db       'Online Shopping System',0
MenuName     db       'MyMenu',0
DlgName	     db       'MyDialog',0
AboutMsg     db       'Name: Zhong Yi',0ah,0dh,'No.U201914978',0
AboutName    db       'ID Message',0
ComputeMsg   db       'Compute Rate Successfully!',0
...
Display      proc   hdc:HDC
	     ...
	     YY_GAP equ  30
             ...
             invoke TextOut,hdc,XX+5*XX_GAP,YY+0*YY_GAP,offset msg_rate,10
